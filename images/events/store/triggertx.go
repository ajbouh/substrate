...
func (tx *TriggerTx) Notify(ctx context.Context, id event.ID) error {
	return tx.execExpr(ctx, renderInsertReactionNotification(id))
}

func (tx *TriggerTx) Create(ctx context.Context, trigger ReactionQueryTrigger) error {
