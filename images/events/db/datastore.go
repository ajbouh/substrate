...
type EventDataWriter interface {
	WriteEventData(ctx context.Context, tx Tx, id event.ID, read io.Reader) (int64, EventDataCommitFunc, error)
}
...
func (ds *ExternalDataStore) WriteEventData(ctx context.Context, tx Tx, id event.ID, r io.Reader) (int64, EventDataCommitFunc, error) {
...
func (ds *DBDataStore) WriteEventData(ctx context.Context, tx Tx, id event.ID, r io.Reader) (int64, EventDataCommitFunc, error) {
