<script>
  ...
  import Logo from '$lib/assets/logotype.png'
            ...
            <ol class="flex items-center space-x-2">
              <li>
                <div class="flex items-center">
                  ...
                  <a href="{urls.ui.user({user: space.owner})}" class="ml-2 hover:text-gray-700">{space.owner}</a>
                </div>
              </li>
              <li>
                <div class="flex items-center">
                  ...
                  <a href="#" class="ml-2 hover:text-gray-700 truncate">{space.alias}</a>
                </div>
              </li>
            </ol>
          </h2>
          {#if space.forked_from}
            <div class="text-gray-500 text-xs ml-2 mt-0.5">Forked from&nbsp;<a class="font-medium" href="{urls.ui.space({space: space.forked_from})}">{space.forked_from}</a></div>
          {/if}
      </div>
    </nav>
  </NavHeader>
