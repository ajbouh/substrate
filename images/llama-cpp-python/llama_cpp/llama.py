...
class Llama:
    ...
    def _convert_completion_to_chat(
        ...
        if stream:
            ...
            return self._convert_text_completion_to_chat(completion, decode_function_call=decode_function_call)
    ...
    def create_chat_completion(
        ...
        return self._convert_completion_to_chat(completion_or_chunks, stream=stream, decode_function_call=bool(functions))  # type: ignore
