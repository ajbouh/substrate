...
enable: "llama-server": true

imagespecs: "llama-server": {
    image: "\(#var.image_prefix)llama-server"
    build: dockerfile: "images/llama-server/Dockerfile"
}

#commands: "llama-server": [string]: {
    #base_url: string
    command.ViaHTTP
    msg: http: request: {
        method: "POST"
...
#commands: "llama-server": "tokenize": {
    #base_url: string
    meta: {
...
#commands: "llama-server": "embedding": {
    #base_url: string
    meta: {
...
#commands: "llama-server": "completion": {
    #base_url: string
...
#commands: "llama-server": "chat_completion": {
    #base_url: string
    // https://github.com/Mozilla-Ocho/llama-server/blob/main/llama-server/server/doc/v1_chat_completions.md
    meta: {
        "#/data/parameters/model": {type: "string"}
